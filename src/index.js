...
const FB_id = process.argv[4] || process.env.FACEBOOK_CLIENT_ID;
const FB_secret = process.argv[5] || process.env.FACEBOOK_CLIENT_SECRET;
...
//       "test": "nodemon -r dotenv/config ./src/index.js",
